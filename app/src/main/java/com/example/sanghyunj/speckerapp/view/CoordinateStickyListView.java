package com.example.sanghyunj.speckerapp.view;
...
public class CoordinateStickyListView
        extends ExpandableStickyListHeadersListView
        implements NestedScrollingChild, GestureDetector.OnGestureListener {

    private final NestedScrollingChildHelper mNestedScrollingChildHelper;
    private GestureDetectorCompat mDetector;

    public CoordinateStickyListView(Context context) {
        this(context, null);
    }

    public CoordinateStickyListView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CoordinateStickyListView(Context context, AttributeSet attrs, int defStyleAttr) {
