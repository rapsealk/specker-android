package com.example.sanghyunj.speckerapp.view.pulltozoom;
...
//        setGravity(Gravity.CENTER);
        ...
        Log.d("asdasdasdsa2", ViewGroup.LayoutParams.MATCH_PARENT+":"+ViewGroup.LayoutParams.MATCH_PARENT);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        Log.d("asdasdasdsa", widthMeasureSpec+":"+heightMeasureSpec);
    }
